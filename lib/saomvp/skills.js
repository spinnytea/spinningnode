...
Skill.HealthRegen = function() { return new Skill('Health Regen', 'Regenerate when not at full health.', 50); };
Skill.DetectPower = function() { return new Skill('Detect Power', 'Determine the strengths of a target.', 10); };
Skill.QuickDraw = function() { return new Skill('Quick Draw', 'Draw your weapon in half the time.', 3000, -1); };

function Skill(name, desc, step, level) {
  this.name = name;

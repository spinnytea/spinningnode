 ...
 * @param b a board
 */
exports.solve = function solve(b, Promise) {
  ...
  // find solution
  return recursiveSolve(available, lengths, counts, Promise).then(function(result) {
...
function recursiveSolve(available, lengths, counts, Promise) {
  if(lengths.length === 0)
  ...
  return possible.reduce(function(prev, p, idx, array) {
    return prev.catch(function() {
      ...
      // recurse
      return recursiveSolve(a, l, c, Promise);
    });
